...
export function PlatformPageContent() {
  ...
  return (
    <>
      <section className="bg-scrut-navy bg-scrut-hero py-16 text-white sm:py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-2xl text-lg text-white/75">
            Your organization evolves — {PRODUCT_NAME} keeps up. Automate risk, compliance, and
            security controls with a platform built for growth.
          </p>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 sm:grid-cols-3">
            <div className="text-center sm:text-left">
              ...
              <p className="mt-2 text-lg text-slate-600">Auditor-ready ISMS templates</p>
            </div>
            <div className="text-center sm:text-left">
              <h3 className="text-4xl font-bold tracking-tight text-scrut-navy sm:text-5xl">
                {FRAMEWORKS.length}+
              </h3>
              <p className="mt-2 text-lg text-slate-600">Security & privacy frameworks</p>
            </div>
            <div className="text-center sm:text-left">
              <h3 className="text-4xl font-bold tracking-tight text-scrut-navy sm:text-5xl">
                {integrationStats.totalTools}+
              </h3>
              <p className="mt-2 text-lg text-slate-600">Integration tools catalogued</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="capabilities" className="border-t border-slate-200 bg-[#f4f7fb] py-16 sm:py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-slate-600">
              From leadership dashboards to vendor assessments — explore the full {PRODUCT_NAME}{' '}
              product surface.
            </p>
          </div>
            ...
            {PLATFORM_CAPABILITIES.map((cap) => {
              ...
              return (
                <div
                  key={cap.id}
                  id={cap.id}
                  className="scroll-mt-28 rounded-2xl border border-slate-200 bg-white p-6 transition-all hover:border-scrut-teal/30 hover:shadow-md"
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-brand-50 text-brand-600">
                    <Icon className="h-5 w-5" />
                  </div>
                  <h3 className="mt-4 text-lg font-semibold text-scrut-navy">{cap.title}</h3>
