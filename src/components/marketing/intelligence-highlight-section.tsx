...
export function IntelligenceHighlightSection() {
  return (
    <section className="border-y border-slate-200 bg-[#f4f7fb] py-16 sm:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="order-2 lg:order-1">
            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-scrut-navy p-6 shadow-xl sm:p-8">
              <div className="flex items-center gap-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-scrut-gradient">
                  <Sparkles className="h-6 w-6 text-scrut-navy" />
                </div>
                <div>
                  <p className="font-semibold text-white">{PRODUCT_NAME} Intelligence</p>
          ...
          <div className="order-1 lg:order-2">
            ...
            <Link
              ...
              className="mt-8 inline-flex items-center gap-2 text-sm font-semibold text-scrut-navy hover:text-scrut-blue"
            >
              Explore {PRODUCT_NAME} Intelligence
