...
export default function CloudScanningPage() {
  return (
    <AppShell
      title="Cloud security scanning"
      subtitle="CSPM and cloud misconfiguration findings — open vulnerabilities tracked in Jira"
    >
      <AssuranceSubNav />
      ...
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm">
        <p className="text-slate-600">
          Label Jira issues with <strong>cloud</strong> or <strong>cspm</strong> (or set{' '}
          <code className="text-xs">JIRA_JQL_CLOUD</code>).
        </p>
        <Link
      ...
      <OpenVulnerabilitiesPanel fixedSource="cloud" />
    </AppShell>
  );
}
