...
const INTEGRATION_TOOLS_RAW: Omit<IntegrationTool, 'helpGuidePath' | 'helpGuideUrl'>[] = [
  ...
  { id: 'nmap', name: 'Nmap', domains: ['vapt'], description: 'Network discovery and security auditing — port scan, service detection, and NSE vulnerability scripts.', websiteUrl: 'https://nmap.org', deployment: 'open-source', capabilities: ['Port scanning', 'Service detection', 'NSE vuln scripts', 'XML export'] },
